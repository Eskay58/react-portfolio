  ...
  return (
    <div id="profile_container">
      ...
      <section class="text-gray-600 body-font ">
        <div class="container mx-auto flex px-5 md:flex-row-reverse flex-col items-center max-w-screen-lg">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pr-8 md:pr-8 flex flex-col md:items-start md:text-left mb-4 md:mb-0 items-center text-center">
